...
#       'dataset',
#       type=str,
#       default="/root/datasets/kitti_lidarseg",
...
#   )
  ...
  FLAGS.task = "segmentation"
  FLAGS.zipfile = "/root/map-volume/255_19/test_results/SPTM.zip"
  FLAGS.dataset = "/root/datasets/kitti_lidarseg"
